...
const Header = () => {
  return (
    <div className="header">
      <div className="logo">
        <img src="https://www.shutterstock.com/image-vector/food-finder-app-logo-design-260nw-1328492696.jpg"></img>
      </div>
...
const CustomCard = ({ title, cuisines, avgRating, deliveryTime, imageURL }) => {
  return (
    <div className="card">
      <div
...
const resData = [
  {
    ...
    analytics: {
      context: "seo-data-8dee35a6-ea1c-490e-a64e-ba42801587d0",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      cuisines: ["Chinese", "Coastal", "Desserts", "Jain", "South Indian"],
      avgRating: 4.6,
      parentId: "154066",
      avgRatingString: "4.6",
      totalRatingsString: "5K+",
    ...
    <div className="card-container">
      {resData.map((item) => (
        <CustomCard
          ...
          imageURL={`https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/${item.info.cloudinaryImageId}`}
        />
      ))}
    </div>
  );
...
const Footer = () => {
  return (
    <div className="footer">
      <div>&copy; All rights reserver 2024 | Made by Bikash 🚀</div>
      <div></div>
    </div>
  );
};
